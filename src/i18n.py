...
""",
    ...
    **Contributeur :** Antoine Chèvre 🐐 (et claude.ai....)
    ...
    """,
        ...
        "equipements.caption_carte": "Un point par équipement OSM pondéré (les équipements à pondération nulle, non pertinents, sont masqués), coloré par pondération — gris = pondération faible, rouge = pondération élevée.",
        ...
        "accessibilite.info_grille": "Grille de {nb_carreaux} carreaux, population totale {population} habitants",
...
""",
    ...
    **Contributor:** Antoine Chèvre 🐐 (and claude.ai....)
    ...
    """,
        ...
        "equipements.caption_carte": "One point per weighted OSM facility (zero-weight, irrelevant facilities are hidden), colored by weight — grey = low weight, red = high weight.",
        ...
        "accessibilite.info_grille": "Grid of {nb_carreaux} cells, total population {population}",
